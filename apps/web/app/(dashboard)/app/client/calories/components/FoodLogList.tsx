...
export const FoodLogList = memo(function FoodLogList({ entries }: FoodLogListProps) {
  return (
    <div className="space-y-3">
      ...
      {entries.length === 0 ? (
        <div className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-white/10 bg-[#0E0E18]/60 backdrop-blur-xl py-10">
        ...
        entries.map((entry) => (
          <div key={entry.id} className="rounded-2xl border border-white/10 bg-[#0E0E18]/60 backdrop-blur-xl p-4">
