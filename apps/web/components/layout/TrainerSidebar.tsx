...
export function TrainerSidebar() {
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-40 flex flex-col border-r border-white/[0.06] bg-[#0D0D14] transition-all duration-300 ${
    ...
    >
      ...
      <div className="flex h-16 items-center justify-between border-b border-white/[0.06] px-4">
        {!collapsed && (
          <Link href="/app/trainer/dashboard" className="text-xl font-bold text-white">
        ...
        <button
          ...
          className="rounded-lg p-1.5 text-[#8B8BA3] transition-colors hover:bg-white/[0.05] hover:text-white"
        >
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            {collapsed ? (
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-200 ${
                isActive
                  ? "bg-[#00E5FF]/10 text-[#00E5FF] shadow-[0_0_15px_rgba(0,229,255,0.08)]"
      ...
      <div className="border-t border-white/[0.06] p-3">
        <button
          ...
          className={`flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-[#8B8BA3] transition-all hover:bg-[#FF1744]/10 hover:text-[#FF1744] ${
            collapsed ? "justify-center" : ""
          }`}
        >
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
