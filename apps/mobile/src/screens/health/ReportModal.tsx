...
import { ZONE_LABELS as MUSCLE_LABELS } from "@kuvox/shared";
...
const st = StyleSheet.create({
  ...
  muscleTitle: { fontSize: 16, fontFamily: fonts.extraBold, color: colors.white },
  ...
  painValue: { fontSize: 32, fontFamily: fonts.extraBold, minWidth: 40, textAlign: "center" },
